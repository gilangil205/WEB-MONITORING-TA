...
@section('title', request('section') === 'users' ? 'Pengguna Sistem - Admin' : 'Konfigurasi Threshold - Admin')
...
.admin-users-grid { display:grid; grid-template-columns:1.1fr 1.2fr; gap:24px; align-items:start; }
...
@php
    $activeSection = request('section', 'threshold');
@endphp
