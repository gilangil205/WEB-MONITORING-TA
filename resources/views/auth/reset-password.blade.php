...
<body>
    ...
    <div class="left-side">
        <div class="brand">
            <h1>🌽 SmartFarm</h1>
            <p>
                Sistem monitoring kondisi lingkungan dan deteksi hama tikus pada tanaman jagung berbasis IoT
            </p>
        </div>
    </div>
            ...
            <form method="POST" action="{{ route('password.store') }}">
                ...
                <div class="form-group">
                    ...
                    <input id="email" type="email" name="email" value="{{ old('email', $request->email) }}"
                        class="form-control" placeholder="Masukkan email" required autofocus autocomplete="username">
                    @error('email')
